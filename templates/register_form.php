...
<form action="register.php" method="post">
    <fieldset>
       ...
       <div class="form-group">
        ...
        <div class="form-group">
            <input autofocus class="form-control" name="emailconfirmation" placeholder="Confirm Email" type="text"/>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <input class="form-control" name="passconfirmation" placeholder="Confirm Password" type="password"/>
        </div>
        <div class="form-group">
